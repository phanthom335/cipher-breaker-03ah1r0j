    """
    Cipher Breaker 03ah1r0j
    =======================
    Fun terminal game that challenges players to complete puzzles in ASCII art.
    ...
    APP_NAME    = "Cipher Breaker 03ah1r0j"
    APP_VERSION = "1.0.0"
...
return {"score": score, "rounds": guessed_in, "won": score > 0}
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Fun terminal game that challenges players to complete puzzles in ASCII art.")
